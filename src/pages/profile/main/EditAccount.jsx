...
const EditAccount = () => {
  ...
  const allPasswordValid =
    ...
    (Object.values(requirements).every(Boolean) && passwordsMatch);
  ...
  return (
    <div className="flex flex-col gap-4 max-w-md mb-2 w-full mx-auto p-6 bg-white rounded-xl shadow-lg border border-gray-200">
